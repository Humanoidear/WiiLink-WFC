        ...
        .then((data) => {
          for (let j = 0; j < data.length; j++) {
            ...
            if (data[0].GameID == gameid) {
              ...
              if (data[0].GameID.substring(0, 3) == "RMC") {
