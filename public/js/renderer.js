    ...
    if (
      ...
      for (var j = 0; j < locales.length; j++) {
        ...
        if (locales[j].getAttribute("lang") === desiredLang) {
          ...
          img.style.animation = "fadein 100ms 0.3s ease-in-out forwards";
          img.style.opacity = "0";
          img.innerHTML =
